...
```bash
brew tap yourusername/cc-token-monitor
...
```bash
# 克隆仓库
git clone https://github.com/yourusername/cc-token-monitor.git
cd cc-token-monitor
...
```bash
curl -fsSL https://raw.githubusercontent.com/yourusername/cc-token-monitor/main/install.sh | bash
```
